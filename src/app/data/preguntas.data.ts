...
export const RAMAL_UNO: Record<string, Pregunta[]> = 
{
  "Cabecera Lanús": [
    {
      "seccion": "1",
   ...
   "Av. Pueyrredón": [
    {
      ...
      "Lugares": ["Tagle", "Hospital Rivadavia", "Sanchez de Bustamante", "Hospital Fernandez", "Ocampo", 
                  "Av. Coronel Diaz", "CEMIC", "Salguero", "Eco Parque", "Plaza Italia", "Embajada de Estados Unidos"],
      "respuesta": 6
    }
  ],
}

export const RAMAL_TRES: Record<string, Pregunta[]> = 
{
  "Cabecera Lanús": [
    {
      "seccion": "1",
...
export const RAMAL_CUATRO: Record<string, Pregunta[]> = 
{
  "Cabecera Lanús": [
    {
      "seccion": "1",
  ...
  "Av. Alcorta": [
   ...
   "Aeroparque": [
    {
      "seccion": "8",
      "Lugares": ["Aeroparque", "Costanera", "Paque de la memoria", "Tierra Santa", "Costa Salguero",
                  "Ciudad Universitaria"],
      "respuesta": 8
    }
  ]
